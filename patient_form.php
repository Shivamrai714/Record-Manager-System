...
//include("connection_pform.php");   //old was this
...
<form action="display.php" method="POST" autocomplete="off"  onsubmit="return validation()" >
...
<td align ="right" colspan="2"   > 
   <!-- <input type="home" name="home" id="btn" >
 -->
  <button id="btn1"> <a href="login.php">Registed Login</a></button>
