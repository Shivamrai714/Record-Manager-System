...
{content:"";
    position:absolute;
    background:url("img/s.jpg")no-repeat center center/cover;    /*to adjust teh img to centre */
top:0;
...
<section id="home">
	<div id="box">
		...
		<form method="post">
			<div style="font-size: 20px;margin: 10px;color: white; text-align: center;">Patient Login</div>
<br>
