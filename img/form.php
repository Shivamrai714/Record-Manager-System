...
<form action="#" method="" autocomplete="off"  onsubmit="return validation()" >
...
<tr><td>
CARD No.<td> <input type="text"  name="cardno"  id="card" placeholder="card no"  size="33" > <br> <span id="cardd"></span> 
</td> </tr>
...
if($data)
{
   echo "data inserted successfully into databse";
}
else 
{
